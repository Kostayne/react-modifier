...
exports.getHeadModifierByProps = exports.mixModifiers = exports.modifyWithPrioritet = exports.modifyElement = exports.createModifier = exports.ModifiableComponent = void 0;
...
function modifyElement(elem, mod) {
    if (!mod)
        throw new Error("Modifier is null or undefined");
    var resClass = classnames_1["default"](elem.props.className || "", mod.className);
    return react_1["default"].cloneElement(elem, { className: resClass, id: mod.id });
}
exports.modifyElement = modifyElement;
function modifyWithPrioritet(elem, mod) {
    if (!mod)
        throw new Error("Modifier is null or undefined");
    var resClass = "";
    if (elem.props.className) {
        var modClasses = mod.className.split(" ");
        var elemClasses = elem.props.className.split(" ");
        resClass = classnames_1["default"](modClasses, elemClasses);
    }
    return react_1["default"].cloneElement(elem, { className: resClass, id: mod.id });
}
exports.modifyWithPrioritet = modifyWithPrioritet;
